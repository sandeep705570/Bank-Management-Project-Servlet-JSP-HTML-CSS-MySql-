...
<body bgcolor='green'>
        ...
        <ul class="nav-links">
         ...
         <!--  <a href="userHome.jsp" style="background-color:red; padding:10px 20px; color:black;"><b>Back</b></a>  -->
          <h1 style="text-align:center; background-color:green; color:white;"><i class="fa-solid fa-user-doctor"></i><u>Profile Details</u></h1><br>
          <h2 style=" text-align:center;color:white;"><i class="fa-solid fa-chess-queen"></i>Name: <%=rs.getString(1) %></h2><br>
          <h2 style=" text-align:center;color:white;"><i class="fa-solid fa-envelope-circle-check"></i>Email: <%=rs.getString(8) %></h2><br>
          <h2 style=" text-align:center;color:white;"><i class="fa-solid fa-mobile"></i>Mobile Number: <%=rs.getString(9) %></h2><br>
          <h2 style=" text-align:center;color:white;"><i class="fa-solid fa-building-columns"></i>Account Number: <%=rs.getString(10) %></h2><br>
