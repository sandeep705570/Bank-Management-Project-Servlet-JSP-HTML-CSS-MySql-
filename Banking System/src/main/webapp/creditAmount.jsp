...
<body>
    ...
    <div class="form-container">
        <div class="form-header">
             Credit Amount <i class="fa-solid fa-credit-card"></i>
        ...
        <form action="creditAmountAction.jsp" method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" name="credit" placeholder="Enter Amount" required style="flex: 1;padding: 12px;border-radius: 4px;background-color: #e9ecef;font-size: 0.9rem;">
            </div>
            ...
            &nbsp; &nbsp; &nbsp; <a href="userHome.jsp" style="background-color:red; padding:10px 25px; color:white;"><b>Back</b> <i class="fa-solid fa-circle-arrow-left"></i></a>
         </form>
    </div>
