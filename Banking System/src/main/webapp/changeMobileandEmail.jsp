...
<body bgcolor='lightblue'>
    ...
    <div class="form-container">
        <div class="form-header">
              <center><h1 style="background-color:pink;color:black;">Change Mobile Number & Email</h1></center><br><br>
              <%
     String msg=request.getParameter("msg");
     if("changed".equals(msg))
     {
   %>
    <center><h1 style="color:green;">Mobile No. & Email has been Changed...</h1></center>
  <%} %>
  <%
  ...
  <%} %>
        ...
        <form action="changeMobileandEmailAction.jsp" method="post">
            
            <div class="form-group">
                <label>Email</label>
                <input type="text" name="email" value="<%=rs.getString(9)%>">
            </div>
            
            <div class="form-group">
                <label>Mobile Number</label>
                <input type="text" name="mobileNumber" value="<%=rs.getString(10)%>">
            </div>
