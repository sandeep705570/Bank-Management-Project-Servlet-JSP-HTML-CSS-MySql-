...
<body>
    ...
    <nav>
        ...
        <div class="nav-links">
            <a href="#"><i class="fa-solid fa-user-tie"></i> <%out.println("Account="+account); %></a>
            <a href=""><%out.println("Password="+pass); %></a>
            <a href=" "><i class="fa-solid fa-credit-card"></i> Debit</a>
            <a href=" "><i class="fa-regular fa-credit-card"></i> Credit</a>
            <a href=" "><i class="fa-solid fa-eye"></i> Check Balance</a>
            <a href="adminHome.jsp"><i class="fa-solid fa-bell"></i> Customers</a>
            <a href="../registation.jsp"> <i class="fa-solid fa-arrow-up-right-from-square"></i> Open Account</a>
            <a href="allCustomers.jsp"><i class="fa-solid fa-bars"></i> All Customers</a>
    ...
    <div class="hero">
        <div class="content">
            ...
            <h1>BANK</h1>
            <div class="sub-heading">Save to Safe</div>
